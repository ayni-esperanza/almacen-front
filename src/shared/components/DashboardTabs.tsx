...
export const DashboardTabs = ({ currentPath }: DashboardTabsProps) => {
  ...
  return (
    <div className="sticky top-[63px] z-30 flex items-center px-2 overflow-x-auto border-b border-gray-200 sm:px-6 bg-gray-50 dark:border-slate-700 dark:bg-slate-900 scrollbar-hide">

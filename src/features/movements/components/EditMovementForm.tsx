...
export const EditMovementForm: React.FC<EditMovementFormProps> = ({
  ...
  const inputClasses =
    "w-full rounded-xl border border-gray-300 px-3 py-1.5 text-sm text-gray-700 transition outline-none focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:focus:border-emerald-400 dark:focus:ring-emerald-500/30 [color-scheme:light] dark:[color-scheme:dark] cursor-pointer";

      ...
      {data.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            {/* Tooltip detallado */}
            {isHovered && (
              <div className="absolute right-0 top-0 z-10 rounded-lg bg-gray-900 px-3 py-2 text-xs text-white shadow-lg dark:bg-slate-800">
                <div className="space-y-1">
                  <div className="font-semibold">{item.name}</div>
                  <div className="flex justify-between space-x-4">
                    <span className="text-gray-300">Gasto:</span>
                    <span className="font-semibold text-emerald-300">{formatCurrency(item.gasto)}</span>
                  </div>
                  <div className="flex justify-between space-x-4">
                    <span className="text-gray-300">Movimientos:</span>
                    <span className="font-semibold text-sky-300">{item.movimientos}</span>
                  </div>
                  <div className="flex justify-between space-x-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="h-3 flex-1 rounded-full bg-gray-200 dark:bg-slate-800">
                  <div 
                    className={`h-3 rounded-full bg-green-500 dark:bg-emerald-500 transition-all duration-500 ease-out ${isHovered ? 'opacity-90' : ''}`}
                    style={{ 
                      width: `${gastoPercentage}%`
                    }}
                  ></div>
                </div>
                <span className="w-16 text-right text-xs font-medium text-gray-600 dark:text-slate-300">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="h-2 flex-1 rounded-full bg-gray-200 dark:bg-slate-800">
                  <div 
                    className={`h-2 rounded-full bg-blue-500 transition-all duration-500 ease-out dark:bg-sky-500 ${isHovered ? 'opacity-90' : ''}`}
